...
while running:
    ...
    if collision:
        if current_velocity == 'left':
            tails.append(Snake(snake.x + 20, snake.y, snake.x_change, snake.y_change, snake.speed))
        if current_velocity == 'right':
            tails.append(Snake(snake.x - 20, snake.y, snake.x_change, snake.y_change, snake.speed))
        if current_velocity == 'up':
            tails.append(Snake(snake.x, snake.y + 20, snake.x_change, snake.y_change, snake.speed))
